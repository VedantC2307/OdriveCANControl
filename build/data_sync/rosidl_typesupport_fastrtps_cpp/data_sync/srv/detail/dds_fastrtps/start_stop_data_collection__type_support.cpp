...
#include "data_sync/srv/detail/start_stop_data_collection__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = data_sync::srv::StartStopDataCollection_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const data_sync::srv::StartStopDataCollection_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<data_sync::srv::StartStopDataCollection_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _StartStopDataCollection_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const data_sync::srv::StartStopDataCollection_Request *>(
...
static size_t _StartStopDataCollection_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_StartStopDataCollection_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _StartStopDataCollection_Request__callbacks = {
  "data_sync::srv",
...
static rosidl_message_type_support_t _StartStopDataCollection_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_StartStopDataCollection_Request__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_data_sync
const rosidl_message_type_support_t *
get_message_type_support_handle<data_sync::srv::StartStopDataCollection_Request>()
{
  return &data_sync::srv::typesupport_fastrtps_cpp::_StartStopDataCollection_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = data_sync::srv::StartStopDataCollection_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const data_sync::srv::StartStopDataCollection_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<data_sync::srv::StartStopDataCollection_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _StartStopDataCollection_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const data_sync::srv::StartStopDataCollection_Response *>(
...
static size_t _StartStopDataCollection_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_StartStopDataCollection_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _StartStopDataCollection_Response__callbacks = {
  "data_sync::srv",
...
static rosidl_message_type_support_t _StartStopDataCollection_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_StartStopDataCollection_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &data_sync::srv::typesupport_fastrtps_cpp::_StartStopDataCollection_Response__handle;
}
...
static service_type_support_callbacks_t _StartStopDataCollection__callbacks = {
  "data_sync::srv",
...
static rosidl_service_type_support_t _StartStopDataCollection__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_StartStopDataCollection__callbacks,
...
{
  return &data_sync::srv::typesupport_fastrtps_cpp::_StartStopDataCollection__handle;
}
