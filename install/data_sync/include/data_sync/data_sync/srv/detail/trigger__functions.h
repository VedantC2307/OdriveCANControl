...
#ifndef DATA_SYNC__SRV__DETAIL__TRIGGER__FUNCTIONS_H_
#define DATA_SYNC__SRV__DETAIL__TRIGGER__FUNCTIONS_H_
 ...
 * calls
 * data_sync__srv__Trigger_Request__init().
...
/**
 * It calls
 * data_sync__srv__Trigger_Request__fini()
 ...
 * data_sync__srv__Trigger_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * data_sync__srv__Trigger_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * data_sync__srv__Trigger_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_data_sync
...
/**
 * It calls
 * data_sync__srv__Trigger_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_data_sync
...
/**
 * It allocates the memory for the array and calls
 * data_sync__srv__Trigger_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_data_sync
...
/**
 * It calls
 * data_sync__srv__Trigger_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DATA_SYNC__SRV__DETAIL__TRIGGER__FUNCTIONS_H_
