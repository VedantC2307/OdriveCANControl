...
#include "data_sync/srv/detail/trigger__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const data_sync::srv::Trigger_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: start
  cdr << (ros_message.start ? true : false);
  // Member: topic_name_1
  cdr << ros_message.topic_name_1;
  // Member: topic_name_2
  cdr << ros_message.topic_name_2;
  // Member: filename
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  data_sync::srv::Trigger_Request & ros_message)
{
  // Member: start
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = data_sync::srv::Trigger_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const data_sync::srv::Trigger_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<data_sync::srv::Trigger_Request *>(
    untyped_ros_message);
...
{
  return &data_sync::srv::typesupport_fastrtps_cpp::_Trigger_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, data_sync, srv, Trigger_Request)() {
  return &data_sync::srv::typesupport_fastrtps_cpp::_Trigger_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_data_sync
cdr_serialize(
  const data_sync::srv::Trigger_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  data_sync::srv::Trigger_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = data_sync::srv::Trigger_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const data_sync::srv::Trigger_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<data_sync::srv::Trigger_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &data_sync::srv::typesupport_fastrtps_cpp::_Trigger_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, data_sync, srv, Trigger_Response)() {
  return &data_sync::srv::typesupport_fastrtps_cpp::_Trigger_Response__handle;
}
...
{
  return &data_sync::srv::typesupport_fastrtps_cpp::_Trigger__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, data_sync, srv, Trigger)() {
  return &data_sync::srv::typesupport_fastrtps_cpp::_Trigger__handle;
}
